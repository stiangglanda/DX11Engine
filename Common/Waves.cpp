...
#include <vector>
#include <cassert>
#include "../DirectX11_Tests/BlurDemo/BlurFilter.h"
...
void Waves::Update(float dt)
{
	...
	if( t >= mTimeStep )
	{
	/*	CalcWave(ID3D11DeviceContext * dc,
			ID3D11ShaderResourceView * inputSRV,
			ID3D11UnorderedAccessView * inputUAV, UINT Width, UINT Height)*/
		//	UINT numGroupsX = mNumCols / 16;
	//	UINT numGroupsY = mNumRows / 16;
	//	cmdList->Dispatch(numGroupsX, numGroupsY, 1);
