...
ID3D11ShaderResourceView* TextureMgr::CreateWICTexture(std::wstring filename)
{
	...
	else
	{
		...
		HRESULT status = DirectX::CreateWICTextureFromFile(md3dDevice, filename.c_str(), &texResource, &srv);
