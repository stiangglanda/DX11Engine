...
void SpriteBatch::Draw(const POINT& position, DirectX::PackedVector::XMCOLOR color)
{
	Sprite sprite;
...
void SpriteBatch::Draw(const POINT& position, const CD3D11_RECT& sourceRect,  DirectX::PackedVector::XMCOLOR color)
{
...
void SpriteBatch::Draw(const CD3D11_RECT& destinationRect,  DirectX::PackedVector::XMCOLOR color)
{
	Sprite sprite;
	sprite.SrcRect  = CD3D11_RECT(0, 0, mTexWidth, mTexHeight);
...
void SpriteBatch::Draw(const CD3D11_RECT& destinationRect, const CD3D11_RECT& sourceRect,  DirectX::PackedVector::XMCOLOR color)
{
	Sprite sprite;
	sprite.SrcRect  = sourceRect;
	sprite.DestRect = destinationRect;
...
void SpriteBatch::DrawString(ID3D11DeviceContext* dc, FontSheet& fs, const std::wstring& text, 
							 const POINT& pos, DirectX::PackedVector::XMCOLOR color)
{
