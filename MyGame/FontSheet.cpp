...
HRESULT FontSheet::BuildFontSheetTexture(ID3D11Device* device, Bitmap& fontSheetBitmap)
{
	...
	Gdiplus::Rect rect(0, 0, mTexWidth, mTexHeight);
	fontSheetBitmap.LockBits(&rect,
		Gdiplus::ImageLockModeRead, PixelFormat32bppARGB, &bmData);

	//Gdiplus::BitmapData* bmData = new Gdiplus::BitmapData();
	//const Gdiplus::Rect* tmp = new Gdiplus::Rect(0, 0, mTexWidth, mTexHeight);
	//fontSheetBitmap.LockBits(tmp,
	//	Gdiplus::ImageLockModeRead, PixelFormat32bppARGB, bmData);
