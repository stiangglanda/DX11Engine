	...
	: Effect(device, filename)
{
	...
	Light3FogShadowTech = mFX->GetTechniqueByName("Light3FogShadow");
	Light1ShadowTech = mFX->GetTechniqueByName("Light1Shadow");
	Light1FogShadowTech = mFX->GetTechniqueByName("Light1FogShadow");
...
SpriteEffect* Effects::SpriteFX = nullptr;
