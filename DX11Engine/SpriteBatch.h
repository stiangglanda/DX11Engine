...
public:
	...
	/// 
	void Draw(const POINT& position, DirectX::PackedVector::XMCOLOR color);
	...
	///  white to keep the texture color unchanged.
	/// 
	void Draw(const POINT& position, const CD3D11_RECT& sourceRect,	 DirectX::PackedVector::XMCOLOR color);
	...
	///  white to keep the texture color unchanged.
	/// 
	void Draw(const CD3D11_RECT& destinationRect,  DirectX::PackedVector::XMCOLOR color);
	...
	///  white to keep the texture color unchanged.
	/// 
	void Draw(const CD3D11_RECT& destinationRect, const CD3D11_RECT& sourceRect,  DirectX::PackedVector::XMCOLOR color);
	...
	///  white to keep the texture color unchanged.
	/// 
	void DrawString(ID3D11DeviceContext* dc, FontSheet& fs, const std::wstring& text, const POINT& pos,  DirectX::PackedVector::XMCOLOR color);
