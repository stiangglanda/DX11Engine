...
public:
	...
	void Draw(ID3D11DeviceContext* dc, const Camera& cam, DirectionalLight lights[3], ID3D11ShaderResourceView* ssao,
	          ID3D11ShaderResourceView* shadow, CXMMATRIX shadowtrans);
...
public:
	...
	static constexpr int CellsPerPatch = 64;
